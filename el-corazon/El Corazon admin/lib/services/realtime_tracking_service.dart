...
class RealtimeTrackingService extends ChangeNotifier {
  ...
  Future<void> assignDelivery(String orderId, String deliveryId) async {
    ...
    debugPrint(
        'RealtimeTrackingService: assignDelivery($orderId, $deliveryId)');
  }
  ...
  Future<void> acceptDelivery(String orderId) async {
    ...
    debugPrint('RealtimeTrackingService: acceptDelivery($orderId)');
  }

  /// Marque une commande comme livrée
  Future<void> markAsDelivered(String orderId) async {
    await _supabaseService.markAsDelivered(orderId);
    debugPrint('RealtimeTrackingService: markAsDelivered($orderId)');
  }
  ...
  Future<void> updateDeliveryLocation(
    ...
    debugPrint(
        'RealtimeTrackingService: updateDeliveryLocation($orderId, $latitude, $longitude)');
  }
  ...
  Future<void> sendNotification(String targetUserId, String message) async {
    ...
    debugPrint('RealtimeTrackingService: sendNotification($targetUserId, ...)');
  }

  /// Crée une nouvelle commande avec géocodage automatique
  Future<String?> createOrderWithGeocoding(
      Map<String, dynamic> orderData) async {
    final orderId = await _supabaseService.createOrderWithGeocoding(orderData);
    debugPrint(
        'RealtimeTrackingService: createOrderWithGeocoding(...) -> $orderId');
    return orderId;
  }
  ...
  Future<List<Order>> getUserOrders(String userId) async {
    ...
    debugPrint(
        'RealtimeTrackingService: getUserOrders($userId) -> ${orders.length} orders');
    return orders;
  }
