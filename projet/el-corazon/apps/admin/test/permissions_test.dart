...
void _permissionsDeNavigation() {
  ...
  const exigees = {
    ...
    'Remboursements': 'orders.read',
    'Retraits livreurs': 'payouts.read',
    'Menu': 'catalog.read',
    'Catégories': 'catalog.read',
    'Personnalisations': 'catalog.read',
    'Avis clients': 'catalog.read',
    'Stock': 'inventory.read',
    'Validations': 'inventory.read',
    'Recettes': 'recipes.read',
    'Ingrédients': 'inventory.read',
    'Clients': 'customers.read',
    'Service client': 'support.read',
