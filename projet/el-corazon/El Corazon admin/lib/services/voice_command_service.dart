...
class VoiceCommandService extends ChangeNotifier {
  ...
  // Web-compatible voice service without speech_to_text
  ...
  Future<void> initialize() async {
    ...
    _isAvailable = true; // Simulate availability for web
    _initializeSupportedCommands();
    debugPrint('VoiceCommandService: Service initialisé avec succès (Web)');
    notifyListeners();
  }
  ...
  Future<void> startListening() async {
    ...
    if (_isAvailable && !_isListening) {
      // Web-compatible listening simulation
      _isListening = true;
      debugPrint('VoiceCommandService: Écoute démarrée (Web simulation)');
      notifyListeners();
    }
  }
  ...
  Future<void> stopListening() async {
    if (_isListening) {
      _isListening = false;
      debugPrint('VoiceCommandService: Écoute arrêtée (Web simulation)');
      notifyListeners();
    }
  }
