    ...
    Rubrique(
        ...
        (
            Plat(
                ...
                12,
                620,
                ("pain brioché", "bœuf", "cheddar", "oignon", "cornichon"),
                ("gluten", "lait"),
                (),
                populaire=True,
                groupes=B,
            ...
            Plat(
                ...
                15,
                980,
                ("pain brioché", "bœuf", "cheddar", "bacon", "oignon rouge"),
                ("gluten", "lait"),
                (),
                populaire=True,
                groupes=B,
            ...
            Plat(
                ...
                14,
                710,
                ("pain brioché", "poulet", "salade", "tomate"),
                ("gluten", "œuf"),
                (),
                groupes=B_VEGE,
            ),
            Plat(
                "burger-bbq-oignons",
                "Burger BBQ Oignons Confits",
                3500,
                "Steak de bœuf, oignons longuement confits, cheddar et sauce barbecue fumée.",
                14,
                830,
                ("pain brioché", "bœuf", "oignon confit", "cheddar", "sauce barbecue"),
                ("gluten", "lait"),
                (),
                groupes=B,
            ),
            Plat(
                ...
                18,
                1150,
                ("pain brioché", "bœuf", "cheddar", "bacon", "salade", "tomate"),
                ("gluten", "lait", "œuf"),
                (),
                populaire=True,
                vip=True,
            ...
            Plat(
                ...
                14,
                870,
                ("pain brioché", "bœuf", "œuf", "bacon", "cheddar"),
                ("gluten", "lait", "œuf"),
                (),
                groupes=B,
            ),
            Plat(
                "veggie-burger-avocat",
                "Veggie Burger Avocat",
                2800,
                ...
                12,
                540,
                ("pain complet", "pois chiche", "avocat", "roquette", "tomate séchée"),
                ("gluten",),
                ("vegetarian",),
                groupes=B_VEGE,
            ),
            Plat(
                ...
                14,
                790,
                ("pain brioché", "bœuf", "piment", "jalapeño", "cheddar"),
                ("gluten", "lait"),
                (),
                groupes=B,
            ),
    ...
    Rubrique(
        ...
        (
            ...
            Plat(
                ...
                16,
                720,
                ("poulet", "chapelure", "paprika", "piment"),
                ("gluten", "œuf"),
                ("halal",),
                groupes=G,
            ),
    ...
    Rubrique(
        ...
        (
            Plat(
                ...
                18,
                850,
                ("pâte", "tomate", "mozzarella", "basilic"),
                ("gluten", "lait"),
                ("vegetarian",),
                populaire=True,
                groupes=P,
            ...
            Plat(
                ...
                20,
                960,
                ("pâte", "tomate", "mozzarella", "jambon", "champignon"),
                ("gluten", "lait"),
                (),
                groupes=P,
            ),
            Plat(
                ...
                20,
                1080,
                ("pâte", "crème", "mozzarella", "chèvre", "bleu", "parmesan"),
                ("gluten", "lait"),
                ("vegetarian",),
                groupes=P,
            ),
            Plat(
                ...
                20,
                1020,
                ("pâte", "tomate", "mozzarella", "pepperoni"),
                ("gluten", "lait"),
                (),
                populaire=True,
                groupes=P,
            ...
            Plat(
                ...
                20,
                890,
                ("pâte", "tomate", "mozzarella", "thon", "oignon rouge"),
                ("gluten", "lait", "poisson"),
                (),
                groupes=P,
            ),
            Plat(
                ...
                24,
                1240,
                ("pâte", "tomate", "mozzarella", "bœuf", "poulet", "pepperoni", "poivron"),
                ("gluten", "lait"),
                (),
                vip=True,
                groupes=P,
    ...
    Rubrique(
        ...
        (
            ...
            Plat(
                ...
                30,
                610,
                ("épinard", "huile de palme", "viande", "poisson fumé"),
                ("poisson",),
                (),
                groupes=S,
            ),
    ...
    Rubrique(
        ...
        (
            Plat(
                ...
                10,
                480,
                ("laitue", "poulet", "parmesan", "croûton"),
                ("gluten", "lait", "œuf"),
                (),
                populaire=True,
                groupes=SAL,
            ...
            Plat(
                ...
                10,
                520,
                ("tortilla", "poulet", "salade", "tomate", "carotte"),
                ("gluten", "lait"),
                ("halal",),
                groupes=SAL,
            ),
            Plat(
                ...
                12,
                430,
                ("avocat", "crevette", "mesclun", "agrumes"),
                ("crustacés",),
                (),
                groupes=SAL,
            ),
            ...
            Plat(
                ...
                10,
                390,
                ("avocat", "pois chiche", "tomate cerise", "concombre", "radis"),
                (),
                ("vegetarian", "vegan"),
                groupes=SAL,
            ),
    ...
    Rubrique(
        ...
        (
            ...
            Plat(
                ...
                6,
                510,
                ("fromage frais", "biscuit", "fruits rouges"),
                ("gluten", "lait", "œuf"),
                ("vegetarian",),
                groupes=DES,
            ),
...
class Command(BaseCommand):
    ...
    def _recuperer(url: str, *, essais: int = 4) -> bytes | None:
        ...
        Le schéma est vérifié avant l'ouverture. `urlopen` sert aussi bien
        `file:` que `http:` : une URL de catalogue qui deviendrait un jour
        paramétrable ferait alors lire un fichier du conteneur et le publierait
        comme photo d'article. Le contrôle coûte deux lignes et retire la
        question.
        """
        ...
        for tentative in range(essais):
            try:
                # Schéma validé juste au-dessus : `urlopen` ne peut plus ouvrir
                # ni `file:` ni un schéma exotique.
                requete = urllib.request.Request(url, headers=_AGENT)  # noqa: S310
