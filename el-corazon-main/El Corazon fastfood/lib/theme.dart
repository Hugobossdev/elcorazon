...
class AppColors {
  ...
  static const glassLight = Color(0x99FFFFFF); // Blanc semi-transparent (60%)
  static const glassDark = Color(0x991A1A1A); // Noir semi-transparent (60%)
  static const glassBorderLight =
      Color(0x33FFFFFF); // Bordure blanche subtile (20%)
