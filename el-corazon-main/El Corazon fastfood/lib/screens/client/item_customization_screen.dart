...
class _ItemCustomizationScreenState extends State<ItemCustomizationScreen> {
  ...
  Widget _buildCustomizationSection(
    ...
    final hasRequiredOptions =
        options.any((opt) => opt.isRequired || opt.isDefault) ||
        ...
        children: [
          ...
          isSingleChoice
              ? RadioGroup<String>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      _handleSingleSelection(service, category, value, selectedIds);
                    }
                  },
                  child: Column(
  ...
  Widget _buildSummaryCard(CustomizationService service) {
    ...
    final missingRequiredOptions =
        requiredOptions.where((opt) => !selectedIds.contains(opt.id)).toList();
          ...
          subtitle: option.description != null
              ? Column(
                  ...
                  children: [
                    ...
                    if (option.allergens != null &&
                        option.allergens!.isNotEmpty)
                      GestureDetector(
  ...
  void _addCustomizedItemToCart() {
    ...
    if (!(validation['isValid'] as bool)) {
      _showErrorDialog(List<String>.from(validation['errors'] as List));
      return;
    }
