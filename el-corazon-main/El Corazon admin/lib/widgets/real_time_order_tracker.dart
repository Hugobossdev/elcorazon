...
class _RealTimeOrderTrackerState extends State<RealTimeOrderTracker> {
  ...
  void _startTracking() {
    ...
    _locationUpdatesSubscription = trackingService.deliveryLocationUpdates
        .listen((locationData) {
          if (!mounted) return;
  ...
  void _updateDeliveryLocation(Map<String, double> location) {
    if (!mounted) return;
    ...
    // Web-compatible location update
    debugPrint('Delivery location updated: $location');
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Web-compatible tracking display
          Expanded(
