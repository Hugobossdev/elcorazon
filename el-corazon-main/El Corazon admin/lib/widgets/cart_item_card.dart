            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // Price
                  Text(
                    '${item.menuItem.basePrice.toStringAsFixed(0)} FCFA',
              ...
              children: [
                ...
                Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      // IMPORTANT: Container avec width et height explicites pour garantir une taille définie
                      width: 32,
                      height: 32,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tax
            if (tax > 0)
              _buildSummaryRow('TVA', '${tax.toStringAsFixed(0)} FCFA', theme),
